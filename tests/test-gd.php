...
class Grafikon_GdTest extends Grafikon_Test{
    ...
    function testCompare(){
        $input1 = Grafikon_GdImage::createFromFile($this->lib.'tests/images/lena.png');
        $input2 = Grafikon_GdImage::createFromFile($this->lib.'tests/images/lena-gray.png');
        $editor = Grafikon::getAvailableEditor(array("Gd"));
    ...
    function testResizeFitEnlarge(){
        $image = Grafikon_GdImage::createFromFile($this->lib.'tests/images/sample.gif');
