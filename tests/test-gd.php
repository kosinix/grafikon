...
class Grafikon_GdTest extends Grafikon_Test{

    function testCreateEditor() {
        $editor = new Grafikon_GdEditor();
        $this->assertTrue($editor instanceof Grafikon_GdEditor);
    }

    function testCreateEditorStatic(){
        $exception = false;
        try {
            Grafikon::setEditorList(array('Gd')); // Use GD only
    ...
    function testCompare(){
        $input1 = Grafikon_GdImage::createFromFile($this->lib.'tests/in/lena.png');
        $input2 = Grafikon_GdImage::createFromFile($this->lib.'tests/in/lena-gray.png');
    ...
    function testAddTextOnBlankImage() {
        ...
        $correct = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '.jpg';

        $blank = Grafikon_GdImage::createBlank( 400, 100 );
        $editor = Grafikon::createEditor(array("Gd"));
    ...
    function testAddTextOnJpeg() {
        ...
        $image = Grafikon_GdImage::createFromFile($input);
        $editor = Grafikon::createEditor(array("Gd"));
    ...
    function testResizeFitEnlarge(){
        $image = Grafikon_GdImage::createFromFile($this->lib.'tests/in/sample.gif');
        $output = $this->lib.'tests/out/testResizeFitEnlarge.gif';
        $correct = $this->lib.'tests/assert-gd/testResizeFitEnlarge.gif';
        $editor = Grafikon::createEditor(array("Gd"));
    ...
    public function testCrop(){
        ...
        $output1  = $this->lib . 'tests/out/' . __FUNCTION__ . '1.jpg';
        $correct1 = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '1.jpg';

        $output2  = $this->lib . 'tests/out/' . __FUNCTION__ . '2.jpg';
        $correct2 = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '2.jpg';

        $output3  = $this->lib . 'tests/out/' . __FUNCTION__ . '3.jpg';
        $correct3 = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '3.jpg';

        $output4  = $this->lib . 'tests/out/' . __FUNCTION__ . '4.jpg';
        $correct4 = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '4.jpg';

        $output5  = $this->lib . 'tests/out/' . __FUNCTION__ . '5.jpg';
        $correct5 = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '5.jpg';

        $output6  = $this->lib . 'tests/out/' . __FUNCTION__ . '6.jpg';
        $correct6 = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '6.jpg';

        $output7  = $this->lib . 'tests/out/' . __FUNCTION__ . '7.jpg';
        $correct7 = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '7.jpg';

        $output8  = $this->lib . 'tests/out/' . __FUNCTION__ . '8.jpg';
        $correct8 = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '8.jpg';

        $output9  = $this->lib . 'tests/out/' . __FUNCTION__ . '9.jpg';
        $correct9 = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '9.jpg';
    ...
    public function testSmartCrop(){
        ...
        $correct = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '1.jpg';
        ...
        $correct = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '2.jpg';
        ...
        $correct = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '3.jpg';
        ...
        $correct = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '4.jpg';
        ...
        $correct = $this->lib . 'tests/assert-gd/' . __FUNCTION__ . '5.jpg';
...
$reflectedClass = new ReflectionClass('Grafikon_GdTest');
