 ...
 */
interface Grafikon_EditorInterface {

    /**
     * Blend two images together with the first image as the base and the second image on top. Supports several blend modes.
     *
     * @param Grafikon_ImageInterface $image1 The base image.
     * @param Grafikon_ImageInterface $image2 The image placed on top of the base image.
     ...
     *
     * @return Grafikon_EditorInterface An instance of Editor.
     */
     ...
     *
     * @param string|Grafikon_ImageInterface $image1 Can be an instance of Image or string containing the file system path to image.
     * @param string|Grafikon_ImageInterface $image2 Can be an instance of Image or string containing the file system path to image.
     *
     ...
     *
     * @param Grafikon_ImageInterface $image Instance of Image.
     ...
     *
     * @return Grafikon_ImageInterface An instance of Editor.
     */
     ...
     *
     * @param Grafikon_ImageInterface $image Instance of Image. Saving the image to a different format will have NO effect on the Image instance.
