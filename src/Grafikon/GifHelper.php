<?php
final class Grafikon_GifHelper {

    /**
     * @param $imageFile
     *
     * @return Grafikon_GifByteStream
     * @throws Exception
     */
    public function open($imageFile){
        ...
        return new Grafikon_GifByteStream($bytes);
    }
    ...
    /**
     * @param Grafikon_GifByteStream $bytes
     *
     * @return bool
     */
     ...
     *
     * @param Grafikon_GifByteStream $bytes Decode byte stream into array of GIF blocks.
     *
    ...
    public function expandBlocks($blocks){
        ...
        foreach($blocks as $blockName=>$block){
            $bytes = new Grafikon_GifByteStream($block);
